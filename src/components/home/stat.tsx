...
function Stat() {
  ...
  return (
    <div ref={sectionRef} className="bg-accent w-screen grid grid-cols-1 md:grid-cols-2 px-6 md:px-14 py-14 lg:py-20 md:gap-28 lg:gap-20 gap-10 justify-between mb-24">
      <div>
